  ...
  return (
    <div className="mb-4 flex items-center gap-3">
      <div className="flex-1 flex gap-3">
        ...
        {previewMode === 'create' ? (
          <Button onClick={onSaveAndDownload} variant="outline-blue" className="flex-1 px-4 py-2 rounded-lg transition-colors font-medium flex items-center justify-center gap-2 cursor-pointer">
